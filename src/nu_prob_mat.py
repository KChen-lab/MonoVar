...
class Prob_matrix:
	...
	def fill_matrix(self, sngl_cell_ftr_list, original_n_cells, max_depth, nCr_matrix, pad):
		...
		self.denom_prob_matrix[0,0] = float(sngl_cell_ftr_list[0].Prob_Reads_Given_Genotype(0, max_depth, pad))
	
		self.denom_prob_matrix[2,0] = float(sngl_cell_ftr_list[0].Prob_Reads_Given_Genotype(2, max_depth, pad))
		self.denom_prob_matrix[1,0] = 2*float(sngl_cell_ftr_list[0].Prob_Reads_Given_Genotype(1, max_depth, pad))

		for j in range(1,self.n_cells):
			cell_j_prob_0 = sngl_cell_ftr_list[j].Prob_Reads_Given_Genotype(0, max_depth, pad)
			cell_j_prob_2 = sngl_cell_ftr_list[j].Prob_Reads_Given_Genotype(2, max_depth, pad)
			cell_j_prob_1 = 2*sngl_cell_ftr_list[j].Prob_Reads_Given_Genotype(1, max_depth, pad)
	...
	def fill_matrix_50d(self, sngl_cell_ftr_list, original_n_cells, nCr_matrix):
		...
		self.denom_prob_matrix[0,0] = float(sngl_cell_ftr_list[0].Prob_Reads_Given_Genotype_50d(0))
	
		self.denom_prob_matrix[2,0] = float(sngl_cell_ftr_list[0].Prob_Reads_Given_Genotype_50d(2))
		self.denom_prob_matrix[1,0] = 2*float(sngl_cell_ftr_list[0].Prob_Reads_Given_Genotype_50d(1))
